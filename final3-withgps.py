        ...
        try:
            ...
            for line1 in file1:
                if(line1[1:6]=="GPGGA"):
                    ...
                    s1+=float(l1)+l2
                    s2+=float(l3)+l4
                    #write_file.write(float(l1)+l2,float(l3)+l4
                    n+=1
            var1=s1/n
            var2=s2/n
	    write_file.write(var1,var2)
	    finalline=line.split() 
            lat1=finalline[0]
            long1=finalline[1]
            lat2=finalline[2]
            long2=finalline[3]
	    write_file.write(lat1,long1,lat2,long2)
            distance2= sonar(GPIO_TRIGGER2,GPIO_ECHO2)
            distance1= sonar(GPIO_TRIGGER1,GPIO_ECHO1)
            distance3= sonar(GPIO_TRIGGER3,GPIO_ECHO3)
            write_file.write("lets go"
	    if(lat1>var1 and lat2>var1 and long1>var2 and long2>var2):
		write_file.write("if condition 1 ")
                if(distance3<20 and distance2>20 and distance1>20):
			write_file.write("if condition 1 part 1")
			rightturn()
			time.sleep(0.3)
			forward()
			time.sleep(0.3)
	    	elif(distance1<20 and distance2>20 and distance3>20):
			write_file.write("if condition 1 part 2")
			leftturn()
			time.sleep(0.3)
			forward()
			time.sleep(0.3)
		elif(distance2>20 and distance3>20 and distance1>20):
			write_file.write("if condition 1 part 3")
			forward()
			time.sleep(0.3)
		elif(distance2<20 and distance3>20 and distance1<20):
			write_file.write("if condition 1 part 4")
			reverse()
			time.sleep(0.3)
			leftturn()
			time.sleep(0.3)
		elif(distance2<20 and distance1>20 and distance3<20):
			write_file.write("if condition 1 part 5")
			reverse()
			time.sleep(0.3)
			rightturn()
			time.sleep(0.3)
		elif(distance2<20 and distance1>20 and distance3>20):
			write_file.write("if condition 1 part 6")
			reverse()
			time.sleep(0.3)
			leftturn()
			time.sleep(0.3)
		elif(distance2>20 and distance1<20 and distance3<20):
			write_file.write("if condition 1 part 7")
			forward()
			time.sleep(0.5)
        	else:
                	write_file.write("if condition 1 part 8")
			forward()
            elif(lat1<var1 and var1<lat2 and long1<var2 and var2<long2):
                write_file.write("elif condition 1")
            else:
                write_file.write("in else condition at last")
